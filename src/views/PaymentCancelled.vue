    ...
    <div id="Content" class="flex flex-col flex-1 p-6 pt-0">
      ...
      <main class="flex flex-col gap-6 flex-1">
        ...
        <div class="flex flex-col items-center justify-center min-h-[400px] gap-6">
          <!-- Cancelled Icon -->
          <div class="flex size-24 rounded-full bg-gray-100 items-center justify-center">
            <img src="@/assets/images/icons/close-circle-black.svg" class="size-12" alt="cancelled">
          </div>

          <!-- Cancelled Message -->
          <div class="flex flex-col items-center gap-4 text-center">
            <h1 class="font-bold text-3xl text-gray-600">Payment Cancelled</h1>
