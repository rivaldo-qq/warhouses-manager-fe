      ...
      <div id="Content" class="flex flex-col flex-1 p-6 pt-0">
        ...
        <main class="flex flex-col gap-6 flex-1">
          ...
          <div class="flex flex-col items-center justify-center min-h-[400px] gap-6">
            <!-- Pending Icon -->
            <div class="flex size-24 rounded-full bg-yellow-100 items-center justify-center">
              <img src="@/assets/images/icons/loading.svg" class="size-12 animate-spin" alt="pending">
            </div>
  
            <!-- Pending Message -->
            <div class="flex flex-col items-center gap-4 text-center">
              <h1 class="font-bold text-3xl text-yellow-600">Payment Pending</h1>
